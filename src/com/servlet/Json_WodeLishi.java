...
/**
 * Servlet implementation class Json_WodeLishi
 */
@WebServlet("/Json_WodeLishi")
public class Json_WodeLishi extends HttpServlet {
	ResultSet rs;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//
		String str_download_latest="select * from detail where time=(SELECT max(time) FROM detail)";
		String str_download_all="select * from detail where userID='"+request.getParameter("userID")+"' ORDER BY time DESC ";
