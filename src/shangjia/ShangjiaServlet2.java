...
/**
 * Servlet implementation class ShangjiaServlet2
 */
@WebServlet("/ShangjiaServlet2")
public class ShangjiaServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ResultSet rs;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShangjiaServlet2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//
		ConnToStoreInfo conn=new ConnToStoreInfo(2);
		//
